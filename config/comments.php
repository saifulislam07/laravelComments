...
return [
     ...
     */
    'model' => \IslamRumon\Comments\Comment::class,
     ...
     */
    'permissions' => [
        'create-comment' => 'IslamRumon\Comments\CommentPolicy@create',
        'delete-comment' => 'IslamRumon\Comments\CommentPolicy@delete',
        'edit-comment' => 'IslamRumon\Comments\CommentPolicy@update',
        'reply-to-comment' => 'IslamRumon\Comments\CommentPolicy@reply',
    ],

    /**
     * The Comment Controller.
     * Change this to your own implementation of the CommentController.
     * You can use the \IslamRumon\Comments\CommentControllerInterface
     * or extend the \IslamRumon\Comments\CommentController.
     */
    'controller' => '\IslamRumon\Comments\WebCommentController',
